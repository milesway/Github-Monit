      ...
      <el-card shadow="hover">
        <div :style="styles.dataItem">
          ...
          <div :style="styles.dataItemUnit">
            ...
            <div :style="styles.dataFooter">今日：<span
              :style="trend.today.total?'color:#f5222d':''">{{ trend.today.total }}</span></div>
          </div>
        </div>
      </el-card>
    </el-col>
      ...
      <el-card shadow="hover">
        <div :style="styles.dataItem">
          ...
          <div :style="styles.dataItemUnit">
            ...
            <div :style="styles.dataFooter">今日：<span
              :style="trend.today.risk?'color:#f5222d':''">{{ trend.today.risk }}</span></div>
          </div>
        </div>
      </el-card>
    </el-col>
      ...
      <el-card shadow="hover">
        <div :style="styles.dataItem">
          ...
          <div :style="styles.dataItemUnit">
            ...
            <div :style="styles.dataAmount">{{ !trend.engine.status ? "离线" : "正常" }}</div>
            <div :style="styles.dataFooter">最近：{{ (trend.engine.last * 1000) | timeAgo }}
            </div>
          </div>
        </div>
      </el-card>
